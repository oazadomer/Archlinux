...
# pamac install optimus-manager-git thorium-browser-bin megasync-bin crow-translate papirus-folders-nordic mailspring-bin local-by-flywheel-bin stacer-bin --no-confirm
