...
if [ $GAME == "1" ]
then
    sudo pacman -S --needed optimus-manager optimus-manager-qt steam lutris  protonup-qt wine winetricks giflib lib32-giflib libpng lib32-libpng libldap lib32-libldap gnutls lib32-gnutls \
