...
if [[ $DESKTOP == "1" ]]; then
      ...
      retry_command pacman -S hyprland waybar swaync swaybg swaylock-effects wlogout wireplumber udisks2 nwg-look qt5ct grim slurp swappy wl-clipboard cliphist wofi xdg-desktop-portal-hyprland xdg-desktop-portal-gtk powerdevil blueman kwalletmanager kitty kitty-shell-integration kitty-terminfo dolphin dolphin-plugins pavucontrol ark kate yazi starship btop sddm f2fs-tools gufw traceroute --noconfirm --needed
