...
if [[ $DESKTOP == "1" ]]; then
      ...
      retry_command pacman -S fastfetch topgrade zed catppuccin-cursors-mocha gparted f2fs-tools traceroute gvfs-afc gvfs-goa gvfs-google gvfs-mtp gvfs-gphoto2 gvfs-nfs 7zip xz unrar unzip lzop gdb mtpfs nodejs-lts-jod npm yarn ripgrep python-pip pyenv android-tools vala tk dpkg --noconfirm --needed
      ...
      retry_command pacman -S fastfetch topgrade zed catppuccin-cursors-mocha gparted gvfs-afc gvfs-goa gvfs-google gvfs-mtp gvfs-gphoto2 gvfs-nfs 7zip xz unrar unzip lzop gdb mtpfs nodejs-lts-jod npm yarn python-pip pyenv android-tools vala tk dpkg kvantum kvantum-qt5 --noconfirm --needed
