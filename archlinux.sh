...
if [[ $DESKTOP == "1" ]] then
    ...
    pacman -S debtap yay xdg-terminal-exec-git ollama proton-vpn-gtk-app libappindicator-gtk3 gnome-shell-extension-appindicator papirus-folders ventoy-bin appimagelauncher telegram-desktop oh-my-posh-bin zsh-theme-powerlevel10k-git --noconfirm --needed
