...
if [[ $DESKTOP == "1" ]]; then
      ...
      retry_command pacman -S hyprland hyprpolkitagent hypridle hyprcursor waybar swaync swaybg swaylock-effects wlogout wireplumber udisks2 nwg-look qt5ct grim slurp swappy wl-clipboard cliphist wofi xdg-desktop-portal-hyprland xdg-desktop-portal-gtk powerdevil blueman kwalletmanager kamoso korganizer kitty kitty-shell-integration kitty-terminfo dolphin dolphin-plugins pavucontrol ark yazi starship btop sddm f2fs-tools gufw traceroute --noconfirm --needed
