...
if [[ $DESKTOP == "1" ]] then
    ...
    pacman -S waydroid xpad yay xdg-terminal-exec-git ollama proton-vpn-gtk-app libappindicator-gtk3 gnome-shell-extension-appindicator papirus-folders ventoy-bin appimagelauncher telegram-desktop --noconfirm --needed
...
# pamac install thorium-browser-bin megasync-bin crow-translate mailspring-bin local-by-flywheel-bin stacer-bin papirus-folders-nordic --no-confirm
    ...
    systemctl enable lightdm touchegg waydroid-container
    export TERM="kitty"
...
# pamac install thorium-browser-bin megasync-bin crow-translate mailspring-bin local-by-flywheel-bin stacer-bin papirus-folders-nordic --no-confirm
    ...
    systemctl enable gdm touchegg waydroid-container
    export TERM="kitty"
    export TERMINAL="kitty"
...
# pamac install thorium-browser-bin megasync-bin crow-translate mailspring-bin local-by-flywheel-bin stacer-bin papirus-folders-nordic --no-confirm
    ...
    systemctl enable sddm touchegg waydroid-container
    export TERM="kitty"
    export TERMINAL="kitty"
