...
then
    ...
    pacman -S timeshift timeshift-autosnap plymouth ventoy-bin crow-translate appimagelauncher megasync-bin ttf-ms-fonts bibata-cursor-theme fastfetch bleachbit zsh zsh-autosuggestions zsh-completions zsh-syntax-highlighting zsh-history-substring-search starship --noconfirm --needed
...
then
    ...
    pacman -S timeshift timeshift-autosnap plymouth ventoy-bin crow-translate appimagelauncher megasync-bin ttf-ms-fonts bibata-cursor-theme bleachbit zsh zsh-autosuggestions zsh-completions zsh-syntax-highlighting zsh-history-substring-search starship --noconfirm --needed
    pamac install thorium-browser-bin weektodo-bin stirling-pdf-bin thorium-browser-bin --no-confirm --needed
