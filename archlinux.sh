...
if [ $DESKTOP == "1" ]
then
    pacman -S cinnamon nemo nemo-fileroller xed mint-themes gnome-terminal-transparency fish gnome-themes-extra gnome-keyring system-config-printer lightdm lightdm-slick-greeter xdg-user-dirs xdg-user-dirs-gtk blueman numlockx exfatprogs f2fs-tools traceroute cronie gufw xdg-desktop-portal-gtk gnome-system-monitor gnome-screenshot transmission-gtk gnome-calculator gnome-calendar simple-scan kdenlive mediainfo gthumb snapshot gimp xournalpp redshift openvpn networkmanager-openvpn ttf-ubuntu-font-family noto-fonts noto-fonts-emoji ibus-typing-booster kdenlive audacity vlc mplayer shutter-encoder-bin protonvpn-gui bookworm obs-studio gparted ttf-dejavu ttf-hanazono gvfs-afc gvfs-goa gvfs-google gvfs-mtp gvfs-gphoto2 gvfs-nfs nfs-utils ntfs-3g unrar unzip lzop gdb mtpfs ffmpegthumbs ffmpeg openh264 nodejs npm yarn python-pip pyenv postgresql mariadb mongodb android-tools vala tk filezilla kvantum mint-themes mintlocale lightdm-settings brave-bin downgrade debtap dpkg vscodium xclip python-xlib --noconfirm --needed
...
then
    pacman -S gnome-shell gnome-control-center gnome-terminal-transparency gnome-bluetooth gnome-themes-extra gnome-keyring gnome-backgrounds gnome-tweaks gnome-menus gnome-browser-connector gnome-text-editor nautilus file-roller gdm xdg-user-dirs xdg-user-dirs-gtk fish exfatprogs f2fs-tools traceroute cronie gufw xdg-desktop-portal-gtk xdg-desktop-portal-gnome gnome-online-accounts gnome-system-monitor gnome-screenshot transmission-gtk gnome-calculator gnome-calendar gnome-clocks simple-scan kdenlive mediainfo gthumb snapshot gimp xournalpp openvpn networkmanager-openvpn ttf-ubuntu-font-family noto-fonts noto-fonts-emoji ibus-typing-booster kdenlive audacity vlc mplayer shutter-encoder-bin protonvpn-gui bookworm obs-studio gparted ttf-dejavu ttf-hanazono gvfs-afc gvfs-goa gvfs-google gvfs-mtp gvfs-gphoto2 gvfs-nfs nfs-utils ntfs-3g unrar unzip lzop gdb mtpfs ffmpegthumbs ffmpeg openh264 nodejs npm yarn python-pip pyenv postgresql mariadb mongodb android-tools vala tk filezilla kvantum brave-bin downgrade debtap dpkg vscodium xclip python-xlib --noconfirm --needed
    pacman -S mailspring timeshift timeshift-autosnap plymouth ventoy-bin crow-translate appimagelauncher megasync-bin ttf-ms-fonts bibata-cursor-theme figma-linux  --noconfirm --needed
    systemctl enable gdm
elif [ $DESKTOP == "3" ]
then
    pacman -S plasma-desktop dolphin dolphin-plugins ark konsole fish okular gthumb plasma-nm plasma-pa kdeplasma-addons kde-gtk-config powerdevil bluedevil kscreen kinfocenter sddm sddm-kcm xdg-user-dirs xdg-user-dirs-gtk breeze-gtk pamac-tray-icon-plasma kalk kate plasma-systemmonitor xdg-desktop-portal-gtk xdg-desktop-portal-kde exfatprogs f2fs-tools traceroute cronie ufw spectacle ktorrent merkuro skanlite kdenlive mediainfo gimp xournalpp openvpn networkmanager-openvpn ttf-ubuntu-font-family noto-fonts noto-fonts-emoji kdenlive audacity vlc mplayer shutter-encoder-bin protonvpn-gui bookworm obs-studio partitionmanager ttf-dejavu ttf-hanazono gvfs-afc gvfs-goa gvfs-google gvfs-mtp gvfs-gphoto2 gvfs-nfs nfs-utils ntfs-3g unrar unzip lzop gdb mtpfs ffmpegthumbs ffmpeg openh264 nodejs npm yarn python-pip pyenv postgresql mariadb mongodb android-tools vala tk filezilla brave-bin downgrade debtap dpkg vscodium xclip python-xlib  --noconfirm --needed
    pacman -S mailspring timeshift timeshift-autosnap plymouth ventoy-bin crow-translate appimagelauncher megasync-bin ttf-ms-fonts bibata-cursor-theme figma-linux  --noconfirm --needed
